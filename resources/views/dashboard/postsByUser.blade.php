<x-layouts.app>
    ...
    <x-slot name="sidebar">
        <div class="bg-gray-700 rounded p-2 m-2 ">
            <h1 class="text-white text-xl">Other Users Posts</h1>
    ...
    <div class="bg-gray-700 shadow p-2 py-4 m-2 rounded flex flex-row justify-between">
        <h1 class="text-2xl text-white">{{ $user->name }} posts</h1>
        <button class="bg-blue-600 text-white px-2 py-1 rounded" onclick="goBack()">Back</button>
    </div>
