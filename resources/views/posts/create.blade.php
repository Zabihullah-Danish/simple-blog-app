<x-layouts.app>
    ...
    <div class="bg-gray-700 shadow p-2 py-4 m-2 rounded flex flex-row justify-between">
        <h1 class="text-2xl text-white">Adding New Post</h1>
        <button class="bg-yellow-600 p-2 text-white rounded" onclick="goBack()">Cancel</button>
    </div>
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex flex-col p-1">
                ...
                <div class="flex flex-row justify-between mb-2 pl-2">
                    ...
                    <div class="w-5/6">
                        <x-input class="text-white" type="text" id="category" name="title" placeholder="Enter Title" />
                        @error('title')
                ...
                <div class="flex flex-row justify-between mb-2 pl-2">
                    ...
                    <div class="w-5/6">
                        <x-textarea class="text-white" name="content" id="content" placeholder="Enter Content" rows="7" />
                        @error('content')
                        <p class="text-red-600 pl-2">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mb-2">
                    <div class="float-right pr-2 p-2">
                        <button class="p-2 bg-blue-600 hover:bg-blue-700 text-white rounded tracking-wider" type="submit">Post</button>
                    </div>
                </div>
